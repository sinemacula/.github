...
Sine Macula builds and ships software for startups and scaling enterprises, so we take the security and privacy
of our systems and our clients' data seriously. We appreciate the efforts of security researchers and the wider
community in helping us keep our work safe.
...
- **Email** — contact us at `security@sinemacula.co.uk` if you are unable to use GitHub's reporting tool.
...
This policy applies to repositories owned by the [`sinemacula`](https://github.com/sinemacula) organization.
